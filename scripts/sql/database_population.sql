...
INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (18, 'WALK EAST', 18, NULL, NULL, NULL);
    ...
    INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (19, 'INSPECT', 19, NULL, NULL, NULL);
        INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (20, 'TAKE SPEAR', 20, 4, NULL, 'You have taken the spear and continued walking.');
        INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (21, 'TAKE MAGGOTS', 20, 2, NULL, 'You have taken the maggots and continued walking.');
    -- keep walking
    INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (22, 'KEEP WALKING', 20, NULL, NULL, NULL);
        -- Death
        INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (23, 'WALK EAST', 21, NULL, NULL, NULL);
        -- Go North
        INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (24, 'WALK NORTH', 28, NULL, NULL, NULL);
            INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (25, 'USE FOOD', 21, NULL, NULL, 'You ate some food that you collected and have energy to continue the journey down this path. You end up finding a tribe.');
--Death
-- Walk South 2b3.
INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (26, 'WALK SOUTH', 38, NULL, NULL, NULL);
...
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID,CHOICE_ID) VALUES (2,2);


-- Scenario 3:“Entering a small clearing you see two paths in front of you.” WEST OR SOUTH
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID,CHOICE_ID) VALUES (3,3);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID,CHOICE_ID) VALUES (7,3);

--Scenario 4: GO WEST  “You have approached the edge of a large area of water.”
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID,CHOICE_ID) VALUES(4,4);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID,CHOICE_ID) VALUES(5,4);

--Scenario 6: Turn Back “You walk back to the clearing but a tree falls down blocking your way back to the water.”
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID,CHOICE_ID) VALUES(6,6);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID,CHOICE_ID) VALUES(7,6);

--Scenario 7: GO SOUTH “You have entered another clearing and have noticed a weird sulfur like smell in the air but can’t locate where it’s from.”
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(7,8);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID,CHOICE_ID) VALUES(7,18);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(7,20);

--Scenario 8: GO West choice of Scenario 7
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(8,12);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(8,13);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(8,9);

--Scenario 10: Wait Scenario of Scenario 8
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(10,10);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(10,11);

--Scenario 13: Leave Through Window Choice of Scenario 8
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(13,14);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(13,17);

--Scenario 14: Keep running from Scenario 13
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(14,16);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(14,15);

--Scenario 18: GO EAST choice from Scenario 7 IF YOU HAVE MUSHROOMS
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(18,19);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(18,22);
