...
-- You have found a hot Spring spewing poisonous gas. (CHOICE feedback) -this feedback is only for going west. ref to 2b in doc.
INSERT INTO SCENARIO (SCENARIO_ID, SCENARIO_TEXT, SCENARIO_IS_END, SCENARIO_PLAYER_WON) VALUES (8, 'You feel yourself fainting and you pass out. You awake in a strange home and hear people speaking a language you have never heard before outside. You notice that you have none of your equipment. And are wearing a kind of animal hide. As you glance around the room you notice some rope near the door but can’t find any trace of your former clothes. You also notice a window next to you that could be an escape route.', 0, 0);
