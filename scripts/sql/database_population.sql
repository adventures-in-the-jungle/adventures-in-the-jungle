...
INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (18, 'WALK EAST', 18, NULL, NULL, NULL);
    -- inspect
    INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (19, 'INSPECT', 20, 2, NULL, 'You notice the corpse is of a tribal man, they have a broken spear in their back and are decaying. You have taken the maggots and continued walking.');
    -- keep walking
