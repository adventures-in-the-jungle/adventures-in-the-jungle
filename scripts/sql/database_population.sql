...
INSERT INTO ITEM (ITEM_ID, ITEM_NAME, ITEM_DESCRIPTION) VALUES (4, 'Spear', 2);
...
-- Walk West 2b1.
INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (8, 'WALK WEST', 8, NULL, NULL, 'You have found a hot Spring spewing poisonous gas. You feel yourself fainting and you pass out.');
    -- Wait
    INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (9, 'WAIT', 10, NULL, NULL, NULL);
        -- Win
        INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (10, 'STAY WITH THE TRIBE', 11, NULL, NULL, NULL);
        -- Win
        INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (11, 'ASK HOW TO LEAVE', 12, NULL, NULL, NULL);
    -- Death
    INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (12, 'GRAB ROPE', 9, NULL, NULL, NULL);
    -- Leave through window
    INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (13, 'LEAVE THROUGH WINDOW', 13, NULL, NULL, NULL);
        --Continue Running
        INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (14, 'KEEP RUNNING', 14, NULL, NULL, NULL);
            --Win
            INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (15, 'USE ANIMAL HIDE CLOTHING', 15, NULL, NULL, NULL);
            -- Death
            INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (16, 'SWIM ACROSS', 16, NULL, NULL, NULL);
        -- Death
        INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (17, 'WAIT', 17, NULL, NULL, NULL);


-- Walk East 2b2.
INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (18, 'WALK EAST', 18, NULL, NULL, NULL);
    -- inspect
    INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (19, 'INSPECT', 19, NULL, NULL, NULL);
        INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (20, 'TAKE MAGGOTS', 20, 2, NULL, 'You have taken the maggots and continued walking.');
    -- keep walking
    INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (21, 'KEEP WALKING', 20, NULL, NULL, NULL);
        -- Death (Spike pit)
        INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (22, 'WALK EAST', 21, NULL, NULL, NULL);
        -- Go North
        INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (23, 'WALK NORTH', 28, NULL, NULL, NULL);
            INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (24, 'USE FOOD', 29, NULL, NULL, NULL);
                -- Death (Take Spear)
                INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (25, 'TAKE SPEAR', 26, 4, NULL, 'You pick up the spear and continue walking. You end up finding a tribe.');
                INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (26, 'CONTINUE WALKING', 23, NULL, NULL, NULL);
                    -- Win
                    INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (27, 'STAY WITH TRIBE', 24, NULL, NULL, NULL);
                    -- Win
                    INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (28, 'ASK FOR EXIT', 25, NULL, NULL, NULL);
                -- Loop
                INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (29, 'DONT EAT', 27, NULL, NULL, NULL);

-- Walk South
INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (30, 'WALK SOUTH', 28, NULL, NULL, NULL);
    INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (31, 'USE FOOD', 29, NULL, NULL, NULL);
        INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (32, 'TAKE SPEAR', 30, 4, NULL, 'You pick up the spear and continue walking.');
        -- Death (Dont take spear)
        INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (33, 'CONTINUE WALKING', 36, NULL, NULL, 'You end up finding a tribe.'); -- this is the dont take spear ending.
            INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (34, 'RUN AWAY', 31, NULL, NULL, NULL);
                -- Win
                INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (35, 'TAKE ROPE', 32, NULL, NULL, NULL);
                -- Death (Dont get rope)
                INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (36, 'DONT TAKE ROPE', 33, NULL, NULL, NULL);
            -- Death (Stay and fight)
            INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (37, 'STAY AND FIGHT', 34, NULL, NULL, NULL);
            -- Death (Ask exit)
            INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (38, 'ASK FOR EXIT', 35, NULL, NULL, NULL);
        -- Death (Dont eat)
        INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (39, 'DONT EAT', 37, NULL, NULL, NULL);
-- Death (Ambush)
-- Walk South 2b3.
INSERT INTO CHOICE (CHOICE_ID, CHOICE_TEXT, CHOICE_LEADS_TO, CHOICE_FETCHABLE_ITEM, CHOICE_USABLE_ITEM, CHOICE_FEEDBACK) VALUES (40, 'WALK SOUTH', 38, NULL, NULL, NULL);
...
--Scenario 7: GO SOUTH “Entered another clearing, noticed weird sulfur smell in air, can’t locate where it’s from."
...
--Scenario 18: GO EAST choice from Scenario 7
-- This choice if Mushrooms goes to certain scenario
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(18,19); --
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(18,21); --

--Scenario 19: INSPECT CORPSE from Scenario 18 if have Mushrooms
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(19,20);

--Scenario 20:
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(20,22);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(20,23);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(20,30);

-- Scenario 28:
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(28,24);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(29,24);

-- Scenario 29: If you eat the food from Scenario 28
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(29,25);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(29,26);

--Scenario 30: Continue Walking option from Scenario 22 and for hardcode option
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(30,27);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(30,28);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(30,34);

--Scenario 31: Run away fr
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(31,35);
INSERT INTO SCENARIO_CHOICE(SCENARIO_ID, CHOICE_ID) VALUES(31,36);
-- endregion
